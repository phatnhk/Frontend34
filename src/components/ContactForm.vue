...
export default {
    ...
    data() {
        ...
        return {
            // contactLocal sao chép từ props contact để tránh sửa trực tiếp props
    ...
    methods: {
        ...
        cancel() {
            const reply = window.confirm("Bạn có thay đổi chưa lưu! Bạn có muốn thoát?");
            if (reply) {
    ...
    watch: {
        // Đồng bộ contactLocal mỗi khi contact thay đổi
        contact: {
            handler(newContact) {
